...
public class AuctionConfigGenerator {
  ...
  public static AuctionConfig getAuctionConfig(String seller, String buyer, boolean isContextualAdsRequested) {
    PerBuyerConfig.Builder perBuyerConfigBuilder =
        PerBuyerConfig.builder()
            .setBuyerSignals(BUYER_SIGNALS)
            .setBuyerDebugId(BUYER_DEBUG_ID);

    if (isContextualAdsRequested) {
      perBuyerConfigBuilder.setContextualProtectedAppSignalsData(
          ContextualProtectedAppSignalsData.builder()
              .setAdRenderIds(Collections.singletonList("ad_render_id_3"))
              .build()
      );
    }
    ...
    return AuctionConfig.builder()
        ...
        .setPerBuyerConfig(Collections.singletonMap(buyer, perBuyerConfigBuilder.build()))
