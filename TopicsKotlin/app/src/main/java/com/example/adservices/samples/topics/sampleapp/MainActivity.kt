...
class MainActivity : AppCompatActivity() {
  ...
  private fun registerLaunchSettingsAppButton() {
    settingsAppButton?.setOnClickListener(
      View.OnClickListener {
        val context = applicationContext
        val activity2Intent = Intent(RB_SETTING_APP_INTENT)
        activity2Intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
        context.startActivity(activity2Intent)
      })
  }
  var mTaxonomy: MutableMap<Int, String> = HashMap()
