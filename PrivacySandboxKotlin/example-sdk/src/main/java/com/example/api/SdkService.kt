...
interface SdkService {
     ...
     *
     * For the In-App mediatee, the Adapter is initialised and registered with the mediator from
     * the app. This is unlike the pre-Rubidium world where the App does not directly communicate
     * with mediatee.
